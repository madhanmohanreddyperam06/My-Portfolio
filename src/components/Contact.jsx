              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/madhanmohanreddyperam06" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/madhan-mohan-reddy-peram-63181b253?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* Twitter */}
                    <a href="https://x.com/MadhanM16616334?t=Fat391ZrwB1ZF7M1rZ6REg&s=08" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
