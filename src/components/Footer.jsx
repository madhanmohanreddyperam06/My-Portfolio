...
const Footer = () => {
  ...
  return (
    <footer className="hidden md:block bg-primary py-8 sm:py-12 border-t border-muted border-opacity-20">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-8">
          ...
          >
            <div className="flex items-center mb-2">
              ...
              <span className="font-serif text-base sm:text-lg tracking-wider">
          ...
          >
            <a
              href="#home"
              className="text-muted hover:text-light transition-colors text-sm sm:text-base"
            >
              Home
            </a>
            <a
