...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      liveLink: "",
      githubLink:
        "https://github.com/madhanmohanreddyperam06/Campus-Finder.git",
      highlights: [
    ...
    },
    {
      ...
      liveLink: "",
      githubLink:
        "https://github.com/madhanmohanreddyperam06/Charity-and-Donation-Management-Portal.git",
      highlights: [
    ...
    },
    {
      ...
      liveLink: "",
      githubLink:
        "https://github.com/madhanmohanreddyperam06/Doctor-Appointment-System.git",
      highlights: [
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-8">
            ...
            <div className="flex overflow-x-auto pb-3 scrollbar-hide snap-x snap-mandatory">
              {projects.map((project, index) => (
                <motion.div
                  ...
                  className={`snap-start flex-shrink-0 w-[70%] sm:w-[60%] mr-2 sm:mr-3 p-3 sm:p-4 cursor-pointer transition-all duration-300 ${
                    activeProject === index
          ...
          >
            ...
            >
              <h3 className="text-lg md:text-xl font-semibold mb-2 sm:mb-3">
              ...
              <div className="mb-4 md:mb-6">
                <h4 className="text-xs md:text-sm font-serif mb-2 md:mb-3">
                  KEY HIGHLIGHTS
                </h4>
