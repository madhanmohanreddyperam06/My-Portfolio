  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="bg-primary border border-light border-opacity-30 rounded-lg max-w-4xl max-h-[90vh] overflow-auto relative">
        ...
        <div className="p-6">
          <h3 className="text-xl font-semibold text-light mb-4 font-serif">
            {certificate.title}
          </h3>
          <div className="mb-4">
  ...
  const experiences = [
    {
      ...
      certificate: {
        ...
        description:
          "Certificate of completion for Full Stack Developer Trainee program at Matrimony.com, demonstrating proficiency in web development technologies and contribution to real-world projects.",
      },
    },
    {
      ...
      certificate: {
        ...
        description:
          "Recognition for exceptional performance as a Full Stack Web Developer, showcasing expertise in modern web technologies and successful project delivery.",
      },
    },
    {
      ...
      certificate: {
        ...
        description:
          "Certificate of excellence for AI Development Internship, recognizing contributions to AI-powered applications and innovative solutions in artificial intelligence.",
      },
    },
  ];
            ...
            >
              ...
              <div className="mb-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                  <h3 className="text-lg sm:text-xl font-medium text-light">
                    {exp.position}
                  </h3>
                  <span className="text-sm sm:text-base text-muted font-serif">
                    {exp.duration}
                  </span>
                </div>

                <h4 className="text-base sm:text-lg font-medium text-light mb-1">
                  {exp.company}
                </h4>
                ...
                {exp.certificate &&
                  (exp.certificate.pdf || exp.certificate.image) && (
                    <div className="mt-4">
                      <button
